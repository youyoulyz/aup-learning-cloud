...
\begin{frame}{Mixture of Experts: Core Idea}
    ...
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{img/08-moe-architecture.jpg}
    \end{center}
\end{frame}
...
\begin{frame}{Where Does MoE Fit in Transformer?}
    ...
    \vspace{0.3cm}
    \textbf{Therefore:} MoE only replaces the FFN layer.
\end{frame}
...
\begin{frame}{MoE Penalties vs Dense Models}
    ...
    \begin{itemize}
        ...
        \item GPU load imbalance in distributed training
    \end{itemize}
...
\begin{frame}{Gating Functions: Different Routing Strategies}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{img/08-gating-functions.jpg}
    \end{center}
...
\begin{frame}{Notable MoE Models in Production}
    ...
    \vspace{0.3cm}
    \begin{center}
        \includegraphics[width=0.9\textwidth]{img/08-moe-timeline.jpg}
    \end{center}
\end{frame}
