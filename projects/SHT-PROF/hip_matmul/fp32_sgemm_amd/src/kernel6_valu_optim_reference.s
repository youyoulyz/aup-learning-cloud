...
; %bb.7:                                ; %.preheader192
	...
	v_add_nc_u32_e64 v167, 8, s12
	s_ashr_i32 s14, s12, 31
	v_add_co_u32 v183, s15, v118, s12
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add_co_ci_u32_e64 v184, null, 0, s14, s15
	v_mad_u64_u32 v[168:169], null, v167, s4, v[1:2]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_ashrrev_i32_e32 v169, 31, v168
	v_lshlrev_b64 v[169:170], 2, v[168:169]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v169, vcc_lo, s10, v169
	v_add_co_ci_u32_e32 v170, vcc_lo, s11, v170, vcc_lo
	...
	v_add_nc_u32_e32 v171, s4, v170
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_ashrrev_i32_e32 v172, 31, v171
	v_lshlrev_b64 v[172:173], 2, v[171:172]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v172, vcc_lo, s10, v172
	v_add_co_ci_u32_e32 v173, vcc_lo, s11, v173, vcc_lo
	global_load_b32 v170, v[172:173], off
	v_add_nc_u32_e32 v172, s4, v171
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_ashrrev_i32_e32 v173, 31, v172
	v_lshlrev_b64 v[173:174], 2, v[172:173]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v173, vcc_lo, s10, v173
	v_add_co_ci_u32_e32 v174, vcc_lo, s11, v174, vcc_lo
	global_load_b32 v171, v[173:174], off
	v_add_nc_u32_e32 v173, s4, v172
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_ashrrev_i32_e32 v174, 31, v173
	v_lshlrev_b64 v[174:175], 2, v[173:174]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v174, vcc_lo, s10, v174
	v_add_co_ci_u32_e32 v175, vcc_lo, s11, v175, vcc_lo
	global_load_b32 v172, v[174:175], off
	v_add_nc_u32_e32 v174, s4, v173
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_ashrrev_i32_e32 v175, 31, v174
	v_lshlrev_b64 v[175:176], 2, v[174:175]
	v_add_nc_u32_e32 v174, s4, v174
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
	v_add_co_u32 v175, vcc_lo, s10, v175
	v_add_co_ci_u32_e32 v176, vcc_lo, s11, v176, vcc_lo
	...
	v_add_co_u32 v175, vcc_lo, v183, v119
	v_add_co_ci_u32_e32 v176, vcc_lo, v184, v149, vcc_lo
	v_lshlrev_b64 v[175:176], 2, v[175:176]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v175, vcc_lo, s8, v175
	v_add_co_ci_u32_e32 v176, vcc_lo, s9, v176, vcc_lo
	global_load_b32 v175, v[175:176], off
	v_add_co_u32 v176, vcc_lo, v183, v125
	v_add_co_ci_u32_e32 v177, vcc_lo, v184, v150, vcc_lo
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_add_co_u32 v177, vcc_lo, v183, v130
	v_add_co_ci_u32_e32 v178, vcc_lo, v184, v151, vcc_lo
	v_lshlrev_b64 v[177:178], 2, v[177:178]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v177, vcc_lo, s8, v177
	v_add_co_ci_u32_e32 v178, vcc_lo, s9, v178, vcc_lo
	global_load_b32 v177, v[177:178], off
	v_add_co_u32 v178, vcc_lo, v183, v134
	v_add_co_ci_u32_e32 v179, vcc_lo, v184, v152, vcc_lo
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	...
	v_add_co_u32 v179, vcc_lo, v183, v137
	v_add_co_ci_u32_e32 v180, vcc_lo, v184, v153, vcc_lo
	v_lshlrev_b64 v[179:180], 2, v[179:180]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v179, vcc_lo, s8, v179
	v_add_co_ci_u32_e32 v180, vcc_lo, s9, v180, vcc_lo
	global_load_b32 v179, v[179:180], off
	v_add_co_u32 v180, vcc_lo, v183, v138
	v_add_co_ci_u32_e32 v181, vcc_lo, v184, v154, vcc_lo
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b64 v[180:181], 2, v[180:181]
	v_add_co_u32 v180, vcc_lo, s8, v180
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
	v_add_co_ci_u32_e32 v181, vcc_lo, s9, v181, vcc_lo
	global_load_b32 v180, v[180:181], off
	v_add_co_u32 v181, vcc_lo, v183, v139
	v_add_co_ci_u32_e32 v182, vcc_lo, v184, v156, vcc_lo
	v_lshlrev_b64 v[181:182], 2, v[181:182]
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
	v_add_co_u32 v181, vcc_lo, s8, v181
	v_add_co_ci_u32_e32 v182, vcc_lo, s9, v182, vcc_lo
	global_load_b32 v181, v[181:182], off
	v_add_co_u32 v182, vcc_lo, v183, v140
	v_add_co_ci_u32_e32 v183, vcc_lo, v184, v157, vcc_lo
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
	v_lshlrev_b64 v[182:183], 2, v[182:183]
	v_add_co_u32 v182, vcc_lo, s8, v182
	s_delay_alu instid0(VALU_DEP_2)
	v_add_co_ci_u32_e32 v183, vcc_lo, s9, v183, vcc_lo
	global_load_b32 v182, v[182:183], off
.LBB0_8:                                ; %.loopexit
                                        ;   in Loop: Header=BB0_6 Depth=1
...
.LBB0_9:                                ; %.preheader188
	...
	v_add_nc_u32_e32 v204, s14, v166
